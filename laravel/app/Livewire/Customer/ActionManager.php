...
class ActionManager extends Component
{
    ...
    public function mount()
    {
        ...
        $this->templateType = $organization->settings['org_type'] ?? '';
        $this->resetForm();
    }
    ...
    public function applyActionTemplate()
    {
        ...
        foreach ($actions as $actionData) {
            $exists = OrganizationAction::where('organization_id', $this->organizationId)
            ...
            $actionData['organization_id'] = $this->organizationId;
