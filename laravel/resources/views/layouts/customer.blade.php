...
<head>
  ...
  <title>{{ config('app.name', 'AI Chat Support Customer Panel') }}</title>
      ...
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="#" role="button">
          ...
          @if(Auth::user()->organization)
            <small class="badge badge-primary ml-1">{{ Auth::user()->organization->name }}</small>
          @endif
        </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{ route('customer.crawler') }}" class="nav-link {{ request()->routeIs('customer.crawler') ? 'active' : '' }}">
          ...
          <li class="nav-item">
            <a href="{{ route('customer.live-chats') }}" class="nav-link {{ request()->routeIs('customer.live-chats') ? 'active' : '' }}">
