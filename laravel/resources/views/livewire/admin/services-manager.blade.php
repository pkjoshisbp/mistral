    ...
    <section class="content"><div class="container-fluid">
        ...
        <div class="card-body">
            ...
            <div class="border rounded p-3 mb-4 bg-light">
                <form wire:submit.prevent="{{ $editingId ? 'update' : 'create' }}">
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-2"><label>Price</label><input type="text" wire:model="price" class="form-control"></div>
                        <div class="col-md-2 mb-2"><label>Currency</label><select wire:model="currency" class="form-control"><option value="INR">INR</option><option value="USD">USD</option></select></div>
            ...
            <div class="table-responsive"><table class="table table-striped">
                ...
                <tbody>@forelse($this->services as $svc)<tr><td>{{ $svc->name }}</td><td>{{ $svc->metadata['category'] ?? '-' }}</td><td>
